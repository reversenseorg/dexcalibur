...
//        return (this.type != null)&&(this.type.mime==mime);
    ...
    // todo: must be deducted from a counter or dynamically
    hasFuncs(): boolean {
        return this.__p.hasOwnProperty('f_list');
    }

    // todo: functions must not be stored with the file node to avoid to reach max size of documents in mongodb
