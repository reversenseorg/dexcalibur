...
export class Intent
{
    static OPTIONS:any = OPTIONS.Intent;
    ...
    setOptions(pOptions:any){
        ...
        // extra keys init
        if(this.extra_keys !== undefined && this.extra_keys !== null){
    ...
    buildCommand():string{
        ...
        if(this.extra_opts !== null && this.extra_opts.length > 0)
            str+= ' '+this.extra_opts;


        Logger.debug('[Intent] Command : ',str)
        return str;
    }
}
...
export class IntentCommandFactory
{
    static BINARY = 'am';
    ...
    constructor(type:string, pApplication:string='', extra_opts:string=null){
