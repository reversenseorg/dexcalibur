...
describe('ModelInstruction', function() {


    describe('new', function() {

        it('new', function(){
            let mod:ModelInstruction = new ModelInstruction({});
    ...
    describe('setTryEnd / getTryEnd', function() {
        ...
        it('with BB args', function(){
            let bbEnd:ModelBasicBlock = new ModelBasicBlock({ try_end_name: "try_end_1", line:2000 });
...
console.log(bb);
            expect(bb.getTryEndLabel()).to.equals("try_end_1");
        });
