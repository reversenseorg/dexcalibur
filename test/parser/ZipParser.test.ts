...
describe('ZipParser', function() {
    ...
    describe('ZipParser::parseHeader > ZIP', function() {
        ...
        let path = process.env.HOME+"/dxcws/79e817cf-b109-4c57-b372-dc5a14ce52f6/inputs/main.bin";
        let path2 = process.env.HOME+"/dxcws/79e817cf-b109-4c57-b372-dc5a14ce52f6/inputs/extra.bin";
